...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_DETAIL_FAIL = new ErrorCode(1_004_001_102, "修改手机失败，该手机号({})已经被使用");
    ErrorCode USER_RENZHEN_FAIL = new ErrorCode(1_004_001_103, "认证失败");
    ErrorCode USER_RENZHEN_FAIL2 = new ErrorCode(1_004_001_104, "更新认证信息失败");
