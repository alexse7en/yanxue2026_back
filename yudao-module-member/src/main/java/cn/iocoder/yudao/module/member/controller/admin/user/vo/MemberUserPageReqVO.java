...
public class MemberUserPageReqVO extends PageParam {
    ...
    // TODO 芋艿：登录用户类型；
    @TableField("org_name")       private String  orgName;
    @TableField("org_school")     private String  orgSchool;
    @TableField("org_profession") private String  orgProfession;
    @TableField("idcard")         private String  idcard;
    @TableField("area")           private String  area;
    @TableField("izteacher")      private Integer izteacher;
}
