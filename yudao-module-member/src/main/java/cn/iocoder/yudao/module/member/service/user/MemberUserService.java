...
public interface MemberUserService {
    ...
    boolean addUserDetail(MemberUserDO reqVO);
    boolean addUserRenzhen(MemberUserDO reqVO) throws TencentCloudSDKException;
    /** 指定/取消导师 */
    void updateIzteacher(Long id, Integer izteacher);
