...
public interface MemberUserConvert {
    ...
    @Mappings({
            ...
            @Mapping(source = "bean.status", target = "status"),
            @Mapping(source = "bean.name",target = "name"),
            @Mapping(source = "bean.orgName", target = "orgName"),
            @Mapping(source = "bean.orgSchool", target = "orgSchool"),
            @Mapping(source = "bean.orgProfession", target = "orgProfession"),
            @Mapping(source = "bean.idcard", target = "idcard"),
            @Mapping(source = "bean.izteacher", target = "izteacher"),
            @Mapping(source = "bean.area", target = "area"),
    })
