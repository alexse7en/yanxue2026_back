...
public interface ErrorCodeConstants {
    ...
    ErrorCode EXAM_NOT_EXISTS = new ErrorCode(10801, "试卷设计不存在");
    ...
    ErrorCode ARTICLE_NOT_EXISTS = new ErrorCode(101201, "文章不存在");
    ErrorCode YW_LEVEL_GROUP_NOT_EXISTS = new ErrorCode(101301, "评审分类不存在");
    ...
    ErrorCode YW_AUTH_CONDITION_NOT_EXISTS = new ErrorCode(101501, "评审条件不存在");
    ErrorCode YW_AUTH_DETAIL_NOT_EXISTS = new ErrorCode(101501, "评审明细不存在");
    ErrorCode YW_AUTH_LEVEL_NOT_EXISTS = new ErrorCode(101501, "评审级别不存在");
    ErrorCode YW_LEVEL_GROUP_DETAIL_NOT_EXISTS = new ErrorCode(101501, "评审分组明细不存在");
    ErrorCode YW_LEVEL_GROUP_NORM_NOT_EXISTS = new ErrorCode(101501, "评审分组指标不存在");
    ErrorCode YW_LEVEL_NOT_EXISTS = new ErrorCode(101501, "评审等级不存在");
    ErrorCode YW_LEVEL_CONDITION_NOT_EXISTS = new ErrorCode(101501, "等级条件不存在");
    ...
    ErrorCode YW_ARTICLE_UPVOTE_NOT_EXISTS = new ErrorCode(101901, "文章点赞记录不存在");
    ...
    ErrorCode YW_CERT_STUDENT_APPLY_TOO_MANY = new ErrorCode(102512, "单批最多上传 200 条学生信息，请拆分 Excel 后重新上传");
    ...
    ErrorCode YW_INDUSTRY_SURVEY_TYPE_INVALID = new ErrorCode(102603, "行业研究问卷类型非法");
    ErrorCode YW_INDUSTRY_SURVEY_TYPE_REQUIRED = new ErrorCode(102604, "行业研究问卷类型不能为空");
    ErrorCode YW_INDUSTRY_SURVEY_STATUS_INVALID = new ErrorCode(102605, "行业研究问卷状态非法");
}
